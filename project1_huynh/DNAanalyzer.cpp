...
float findBestSimScore (string genome, string sequence);
void findMatchedGenome (string genome1, string genome2, string genome3, string seq);

int main(){ //Main function with declaration of variables
    int option;
    bool menu_flag=false;

    while (menu_flag == false){ //While statement
        //Menu
        ...
        //Find the Similarity Score option
        if (option == 1){
            string sequence1;
            string sequence2;
            ...
            //Calling for calcSimScore function
            similarityScore = calcSimScore(sequence1, sequence2);

            //Output
            cout << "Similarity score: " << similarityScore << endl; 
        
        //Find the Best Sim Score option
        }else if(option == 2){
            string genome;
            string sequence;
            double bestSimScore;

            //Prompt and asking for user input
            ...
            //Calling findBestSimScore function
            bestSimScore = findBestSimScore(genome,sequence);
            
            //Output
            cout << "Best similarity score: " << bestSimScore << endl;

        //Analyze genome sequences option
        }else if (option == 3){
            string genome1; 
            string genome2; 
            string genome3;
            ...
            //Calling findMatchedGenome function
